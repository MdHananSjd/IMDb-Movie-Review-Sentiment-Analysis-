...
def plot_learning_curve(_model, _X_train_vec, _y_train, title):
    train_sizes, train_scores, test_scores = learning_curve(
        _model, _X_train_vec, _y_train, cv=2, n_jobs=-1, train_sizes=np.linspace(0.1, 1.0, 5)
    )
...
def display_model_results(model, model_name, X_test, y_test, vectorizer, X_train, y_train):
...
def main():
    ...
    with tab_lr:
        ...
        if 'lr_model' in st.session_state:
            display_model_results(st.session_state['lr_model'], "Logistic Regression", st.session_state['X_test'], st.session_state['y_test'], st.session_state['vectorizer'], st.session_state['X_train'], st.session_state['y_train'])
        else:
    ...
    with tab_rf:
        ...
        if 'rf_model' in st.session_state:
            display_model_results(st.session_state['rf_model'], "Random Forest", st.session_state['X_test'], st.session_state['y_test'], st.session_state['vectorizer'], st.session_state['X_train'], st.session_state['y_train'])
        else:
            st.info("Click the button above to train the model.")
    ...
    with tab_svm:
        ...
        if 'svm_model' in st.session_state:
            display_model_results(st.session_state['svm_model'], "SVM", st.session_state['X_test'], st.session_state['y_test'], st.session_state['vectorizer'], st.session_state['X_train'], st.session_state['y_train'])
        else:
            st.info("Click the button above to train the model.")
    ...
    with tab_ensemble:
        ...
        if not all_models_trained:
            ...
            if 'ensemble_model' in st.session_state:
                display_model_results(st.session_state['ensemble_model'], "Voting Ensemble", st.session_state['X_test'], st.session_state['y_test'], st.session_state['vectorizer'], st.session_state['X_train'], st.session_state['y_train'])
            else:
